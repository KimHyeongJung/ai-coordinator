...
category: 상의/하의/아우터/신발/가방/악세서리/기타 중 하나
  판단 기준 (반드시 준수):
  후드 집업·집업 점퍼(full-zip hoodie·zip-up hoodie·zip hoodie·hoodie jacket)→"아우터"
  일반 후드티·맨투맨·스웨트셔츠(pullover hoodie·sweatshirt·crewneck)→"상의"
  가방·백팩·파우치(bag·backpack·purse·pouch·tote)→"가방"
  스포츠 의류(jersey·tank top·leggings·training pants)→"상의"/"하의"
...
season: 봄/여름/가을/겨울 중 해당하는 것 배열
  계절 판단 기준 (반드시 준수):
  의류: 반팔·민소매→여름 필수, 긴팔 니트·코트·패딩→가을·겨울 필수, 얇은 긴팔·트렌치코트→봄·가을
  신발 계절 기준 (신발은 반드시 1개 이상 계절 지정):
    샌들·슬리퍼·뮬(sandal·slipper·mule·flip-flop)→여름
    부츠·어그·롱부츠(boots·ugg·ankle boots·long boots)→가을·겨울
    스니커즈·운동화·로퍼·슬립온(sneakers·loafers·slip-on)→봄·여름·가을
    구두·펌프스·옥스퍼드(dress shoes·pumps·oxford)→봄·가을
    기타 신발(판단 어려울 때)→봄·가을
...
_CATEGORY_NORMALIZE: dict[str, str] = {
    ...
    "zip-up": "아우터", "zip up": "아우터", "zipup": "아우터",
    "full-zip": "아우터", "full zip": "아우터", "fullzip": "아우터",
    "hoodie jacket": "아우터", "hoodie zip": "아우터",
    "후드집업": "아우터", "집업": "아우터", "후드 집업": "아우터",
